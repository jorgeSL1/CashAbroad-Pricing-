...
import {
  ...
  silhouette_default,
  wiggle_default
} from "./chunk-PDLNHXJ6.js";
import "./chunk-PCHUDBRX.js";
import {
  Group,
  require_classnames
} from "./chunk-4XWHU47M.js";
import {
  require_prop_types
...
import {
  ...
  getTicks,
  toString
} from "./chunk-WKQ4HXXN.js";
import "./chunk-HBW4M5Y4.js";
import {
  require_react
...
function Line(_ref) {
  var _ref$from = _ref.from, from = _ref$from === void 0 ? {
    ...
    x: 1,
    y: 1
  } : _ref$to, _ref$fill = _ref.fill, fill = _ref$fill === void 0 ? "transparent" : _ref$fill, className = _ref.className, innerRef = _ref.innerRef, restProps = _objectWithoutPropertiesLoose(_ref, _excluded);
  var isRectilinear = from.x === to.x || from.y === to.y;
  return import_react3.default.createElement("line", _extends({
    ref: innerRef,
...
function LinePath(_ref) {
  var children = _ref.children, _ref$data = _ref.data, data = _ref$data === void 0 ? [] : _ref$data, x = _ref.x, y = _ref.y, _ref$fill = _ref.fill, fill = _ref$fill === void 0 ? "transparent" : _ref$fill, className = _ref.className, curve = _ref.curve, innerRef = _ref.innerRef, _ref$defined = _ref.defined, defined = _ref$defined === void 0 ? function() {
    return true;
  } : _ref$defined, restProps = _objectWithoutPropertiesLoose2(_ref, _excluded2);
  var path = line({
    x,
    y,
    defined,
  ...
  return import_react4.default.createElement("path", _extends2({
    ref: innerRef,
...
function SplitLinePath(_ref) {
  ...
  return import_react30.default.createElement("g", null, splitLineSegments.map(function(segment, index) {
    ...
    })) : import_react30.default.createElement(LinePath, _extends3({
      key: index,
      className,
      data: segment,
      x: getX2,
...
function useText(props) {
  ...
  var wordsByLines = (0, import_react31.useMemo)(function() {
    if (isXOrYNotValid) {
      return [];
    }
    if (width || scaleToFit) {
  ...
  var startDy = (0, import_react31.useMemo)(function() {
  ...
  var transform = (0, import_react31.useMemo)(function() {
    var transforms = [];
    if (isXOrYNotValid) {
      return "";
    }
...
function Text(props) {
  var _props$dx = props.dx, dx = _props$dx === void 0 ? 0 : _props$dx, _props$dy = props.dy, dy = _props$dy === void 0 ? 0 : _props$dy, _props$textAnchor = props.textAnchor, textAnchor = _props$textAnchor === void 0 ? "start" : _props$textAnchor, innerRef = props.innerRef, innerTextRef = props.innerTextRef, verticalAnchor = props.verticalAnchor, angle = props.angle, _props$lineHeight = props.lineHeight, lineHeight = _props$lineHeight === void 0 ? "1em" : _props$lineHeight, _props$scaleToFit = props.scaleToFit, scaleToFit = _props$scaleToFit === void 0 ? false : _props$scaleToFit, capHeight = props.capHeight, width = props.width, textProps = _objectWithoutPropertiesLoose4(props, _excluded4);
  ...
  return import_react32.default.createElement("svg", {
    ...
    fontSize,
    style: SVG_STYLE
  }, wordsByLines.length > 0 ? import_react32.default.createElement("text", _extends4({
    ref: innerTextRef,
    transform
  }, textProps, {
    textAnchor
  }), wordsByLines.map(function(line2, index) {
    return import_react32.default.createElement("tspan", {
      key: index,
      x,
...
function Ticks(_ref) {
  ...
  return ticks.map(function(_ref2) {
    ...
    return import_react33.default.createElement(Group, {
      key: "visx-tick-" + value + "-" + index,
      className: (0, import_classnames30.default)("visx-axis-tick", tickClassName),
      transform: tickTransform
    }, !hideTicks && import_react33.default.createElement(Line, _extends5({
      from,
      to,
      stroke: tickStroke,
      strokeWidth,
      strokeLinecap: "square"
    }, tickLineProps)), tickComponent ? tickComponent(_extends5({}, tickLabelProps, {
      x: to.x,
      y: tickYCoord,
      formattedValue
    })) : import_react33.default.createElement(Text, _extends5({
      x: to.x,
      y: tickYCoord
...
function AxisRenderer(_ref) {
  ...
  var combinedLabelProps = _extends6({}, defaultTextProps, labelProps);
  var tickLabelPropsDefault = _extends6({}, defaultTextProps, typeof tickLabelProps === "object" ? tickLabelProps : null);
  ...
  return import_react34.default.createElement(import_react34.default.Fragment, null, ticksComponent({
    hideTicks,
    horizontal,
    orientation,
    scale,
    ...
    strokeWidth,
    tickLineProps
  }), !hideAxisLine && import_react34.default.createElement(Line, {
    className: (0, import_classnames31.default)("visx-axis-line", axisLineClassName),
    from: axisFromPoint,
    to: axisToPoint,
    stroke,
    strokeWidth,
    strokeDasharray
  }), label && import_react34.default.createElement(Text, _extends6({
    className: (0, import_classnames31.default)("visx-axis-label", labelClassName)
  }, getLabelTransform({
    labelOffset,
...
// node_modules/@visx/axis/esm/axis/Axis.js
var _excluded5 = ["children", "axisClassName", "hideAxisLine", "hideTicks", "hideZero", "innerRef", "left", "numTicks", "orientation", "rangePadding", "scale", "tickFormat", "tickLength", "tickValues", "top"];
function _extends8() {
...
function Axis(_ref) {
  ...
  return import_react35.default.createElement(Group, {
    className: (0, import_classnames32.default)("visx-axis", axisClassName),
    innerRef,
    top,
    left
...
function AxisLeft(_ref) {
  var axisClassName = _ref.axisClassName, _ref$labelOffset = _ref.labelOffset, labelOffset = _ref$labelOffset === void 0 ? 36 : _ref$labelOffset, _ref$tickLength = _ref.tickLength, tickLength = _ref$tickLength === void 0 ? 8 : _ref$tickLength, tickLabelProps = _ref.tickLabelProps, restProps = _objectWithoutPropertiesLoose6(_ref, _excluded6);
  var tickLabelPropsFinal = typeof tickLabelProps === "function" ? tickLabelProps : _extends9({}, leftTickLabelProps, tickLabelProps);
  return import_react36.default.createElement(Axis, _extends9({
    axisClassName: (0, import_classnames33.default)("visx-axis-left", axisClassName),
    labelOffset,
...
function AxisRight(_ref) {
  var axisClassName = _ref.axisClassName, _ref$labelOffset = _ref.labelOffset, labelOffset = _ref$labelOffset === void 0 ? 36 : _ref$labelOffset, _ref$tickLength = _ref.tickLength, tickLength = _ref$tickLength === void 0 ? 8 : _ref$tickLength, tickLabelProps = _ref.tickLabelProps, restProps = _objectWithoutPropertiesLoose7(_ref, _excluded7);
  var tickLabelPropsFinal = typeof tickLabelProps === "function" ? tickLabelProps : _extends10({}, rightTickLabelProps, tickLabelProps);
  return import_react37.default.createElement(Axis, _extends10({
    axisClassName: (0, import_classnames34.default)("visx-axis-right", axisClassName),
    labelOffset,
...
var _excluded8 = ["axisClassName", "labelOffset", "tickLength", "tickLabelProps"];
function _extends11() {
...
function AxisTop(_ref) {
  var axisClassName = _ref.axisClassName, _ref$labelOffset = _ref.labelOffset, labelOffset = _ref$labelOffset === void 0 ? 8 : _ref$labelOffset, _ref$tickLength = _ref.tickLength, tickLength = _ref$tickLength === void 0 ? 8 : _ref$tickLength, tickLabelProps = _ref.tickLabelProps, restProps = _objectWithoutPropertiesLoose8(_ref, _excluded8);
  var tickLabelPropsFinal = typeof tickLabelProps === "function" ? tickLabelProps : _extends11({}, topTickLabelProps, tickLabelProps);
  return import_react38.default.createElement(Axis, _extends11({
    axisClassName: (0, import_classnames35.default)("visx-axis-top", axisClassName),
    labelOffset,
...
function AxisBottom(_ref) {
  var axisClassName = _ref.axisClassName, _ref$labelOffset = _ref.labelOffset, labelOffset = _ref$labelOffset === void 0 ? 8 : _ref$labelOffset, _ref$tickLength = _ref.tickLength, tickLength = _ref$tickLength === void 0 ? 8 : _ref$tickLength, tickLabelProps = _ref.tickLabelProps, restProps = _objectWithoutPropertiesLoose9(_ref, _excluded9);
  var tickLabelPropsFinal = typeof tickLabelProps === "function" ? tickLabelProps : _extends12({}, bottomTickLabelProps, tickLabelProps);
  return import_react39.default.createElement(Axis, _extends12({
    axisClassName: (0, import_classnames36.default)("visx-axis-bottom", axisClassName),
    labelOffset,
