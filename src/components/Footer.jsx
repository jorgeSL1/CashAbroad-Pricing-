...
const Footer = () => {
  ...
  const socialLinks = [
    { 
      name: 'LinkedIn', 
      href: 'https://www.linkedin.com/company/cashabroad/', 
      icon: LinkedInIcon,
      hoverColor: 'hover:bg-[#0077b5]'
    },
    { 
      name: 'Instagram', 
      href: 'https://www.instagram.com/cashabroad/', 
      icon: InstagramIcon,
      hoverColor: 'hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888]'
    },
    { 
      name: 'X', 
      href: 'https://x.com/CashAbroadApp', 
      icon: XIcon,
      hoverColor: 'hover:bg-black'
    },
    { 
      name: 'Facebook', 
      href: 'https://www.facebook.com/cashabroad/', 
      icon: FacebookIcon,
      hoverColor: 'hover:bg-[#1877f2]'
    },
    { 
      name: 'WhatsApp', 
      href: 'https://wa.me/529211330038', 
      icon: WhatsAppIcon,
      hoverColor: 'hover:bg-[#25d366]'
    },
    { 
      name: 'YouTube', 
      href: 'https://www.youtube.com/@cashabroad', 
      icon: YouTubeIcon,
  ...
  return (
    <footer className="bg-[#2d3a8c] text-white">
      {/* Main Footer */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 lg:py-16">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-2">
            ...
            >
              ...
              >
                ...
                <span className="text-xs sm:text-sm break-all">info@cashabroad.one</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-xs sm:text-sm">(921) 305-6586</span>
              </a>
                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className={`w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-white/10 flex items-center justify-center
                               transition-all duration-300 border border-white/10 ${social.hoverColor}
            ...
            <ul className="space-y-2 sm:space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-neutral-300 hover:text-white transition-colors inline-flex items-center gap-1 group text-xs sm:text-sm"
                  >
                    {link.label}
          ...
          >
            ...
            <h4 className="font-semibold mb-3 sm:mb-4 mt-5 sm:mt-6 text-white text-sm sm:text-base">Legal</h4>
            <ul className="space-y-2 sm:space-y-3">
